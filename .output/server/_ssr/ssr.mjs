import { a as __toESM, t as __commonJSMin } from "./chunk-rkUS4SYg.mjs";
import { t as require_react } from "./react-ZbIu7eLJ.mjs";
import { i as toSameOriginAppPath, n as stripBasePath, r as toBrowserNavigationHref } from "./url-utils-Cx2q_dPC.mjs";
...
var client_references_default = {
	"878b1d55daf9": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_878b1d55daf9;
	},
	"de2699100888": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_de2699100888;
	},
	"18b3d54f6901": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_18b3d54f6901;
	},
	"c18db9305e40": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_c18db9305e40;
	},
	"7346d135c2b4": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_7346d135c2b4;
	},
	"5f1cc293b170": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_5f1cc293b170;
	},
	"794020b36b9c": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_794020b36b9c;
	},
	"cd3e30d9f56e": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_cd3e30d9f56e;
	},
	"982569dea541": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_982569dea541;
	},
	"809ff3c8fbc4": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_809ff3c8fbc4;
	},
	"97c65a20db9f": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_97c65a20db9f;
	},
	"fc255789ffde": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_fc255789ffde;
	},
	"7a5c8250a36c": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_7a5c8250a36c;
	},
	"ed7d606e58f7": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_ed7d606e58f7;
	},
	"c24a721b6251": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_c24a721b6251;
	},
	"1b6f97ab563a": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_1b6f97ab563a;
	},
	"f34657f09c1d": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_f34657f09c1d;
	},
	"c951643367b4": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_c951643367b4;
	},
	"b49f265d533b": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_b49f265d533b;
	},
	"3a8a44ae8cda": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_3a8a44ae8cda;
	},
	"f29e6e234fea": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_f29e6e234fea;
	},
	"0deffcb8ffd7": async () => {
		return (await import("./facade__virtual_vinext-rsc-entry-1aCw1VFw.mjs")).export_0deffcb8ffd7;
	}
};
...
async function handleSsr(rscStream, navContext, fontData) {
	return runWithNavigationContext(async () => {
		...
		const { clearServerInsertedHTML, flushServerInsertedHTML, useServerInsertedHTML: _addInsertedHTML } = await import("./navigation-BVGGPutg.mjs");
		...
		try {
			...
			const ssrRoot = ServerInsertedHTMLContext ? (0, import_react.createElement)(ServerInsertedHTMLContext.Provider, { value: _addInsertedHTML }, root) : root;
			...
			const { Fragment } = await import("./react-ZbIu7eLJ.mjs").then((n) => /* @__PURE__ */ __toESM(n.t()));
			let insertedHTML = "";
			for (const el of insertedElements) try {
				insertedHTML += (0, import_server_edge.renderToStaticMarkup)((0, import_react.createElement)(Fragment, null, el));
			} catch {}
			function _escAttr(s) {
...
//#endregion
export { ReadonlyURLSearchParams as _, clearServerInsertedHTML as a, getPrefetchCache as c, storePrefetchResponse as d, _virtual_vinext_app_ssr_entry_default as default, toRscUrl as f, useServerInsertedHTML as g, useSearchParams as h, handleSsr, _registerStateAccessors as i, getPrefetchedUrls as l, useRouter as m, RedirectType as n, flushServerInsertedHTML as o, usePathname as p, ServerInsertedHTMLContext as r, getLayoutSegmentContext as s, PREFETCH_CACHE_TTL as t, setNavigationContext as u, require_react_dom as v };
