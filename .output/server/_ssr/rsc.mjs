import { s as __toESM$1 } from "../_runtime.mjs";
import { t as props } from "../_libs/stylexjs__stylex.mjs";
import { t as require_jsonwebtoken } from "../_libs/jsonwebtoken+[...].mjs";
import { c as stringType, i as enumType, n as arrayType, o as numberType, r as booleanType, s as objectType } from "../_libs/zod.mjs";
...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-CXSKDKtg.js\")",
	"clientReferenceDeps": {
		"878b1d55daf9": {
			"js": [
	...
	"serverResources": { "app/layout.tsx": {
		"js": [],
		"css": ["/assets/index-C9lDKAm1.css"]
	} }
};
//#endregion
//#region node_modules/.nitro/vite/services/rsc/index.js
var import_jsonwebtoken = /* @__PURE__ */ __toESM$1(require_jsonwebtoken());
...
typeof import_react_react_server.createContext === "function" && import_react_react_server.createContext(null);
...
var _g$5 = globalThis;
var _als$3 = _g$5[_ALS_KEY$4] ??= new AsyncLocalStorage$1();
...
async function connection() {
	const { markDynamicUsage, throwIfInsideCacheScope } = await Promise.resolve().then(() => headers_exports);
...
function ViewportHead({ viewport }) {
	...
	if (parts.length > 0) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "viewport",
		content: parts.join(", ")
	}, key++));
	if (viewport.themeColor) {
		if (typeof viewport.themeColor === "string") elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "theme-color",
			content: viewport.themeColor
		}, key++));
		else if (Array.isArray(viewport.themeColor)) for (const entry of viewport.themeColor) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "theme-color",
			content: entry.color,
			...entry.media ? { media: entry.media } : {}
		}, key++));
	}
	if (viewport.colorScheme) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "color-scheme",
		content: viewport.colorScheme
	}, key++));
	return (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: elements });
}
/**
...
function MetadataHead({ metadata }) {
	...
	if (title) elements.push((0, import_jsx_runtime_react_server.jsx)("title", { children: title }, key++));
	if (metadata.description) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "description",
		content: metadata.description
	}, key++));
	if (metadata.generator) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "generator",
		content: metadata.generator
	}, key++));
	if (metadata.applicationName) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "application-name",
		content: metadata.applicationName
	}, key++));
	if (metadata.referrer) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "referrer",
		content: metadata.referrer
	}, key++));
	if (metadata.keywords) {
		const kw = Array.isArray(metadata.keywords) ? metadata.keywords.join(",") : metadata.keywords;
		elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "keywords",
			content: kw
		}, key++));
	}
	if (metadata.authors) {
		...
		for (const author of authorList) {
			if (author.name) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
				name: "author",
				content: author.name
			}, key++));
			if (author.url) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
				rel: "author",
				href: author.url
			}, key++));
		}
	}
	if (metadata.creator) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "creator",
		content: metadata.creator
	}, key++));
	if (metadata.publisher) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "publisher",
	...
	if (metadata.category) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "category",
		content: metadata.category
	}, key++));
	if (metadata.robots) if (typeof metadata.robots === "string") elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		name: "robots",
		...
		if (robotParts.length > 0) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "robots",
			content: robotParts.join(", ")
		}, key++));
		if (googleBot) if (typeof googleBot === "string") elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "googlebot",
			content: googleBot
		}, key++));
		else {
			...
			if (gbParts.length > 0) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
				name: "googlebot",
	...
	if (metadata.openGraph) {
		...
		if (og.title) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			property: "og:title",
			content: og.title
		}, key++));
		if (og.description) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			property: "og:description",
			content: og.description
		}, key++));
		if (og.url) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			property: "og:url",
			content: resolveUrl(og.url) ?? og.url
		}, key++));
		if (og.siteName) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			property: "og:site_name",
			content: og.siteName
		}, key++));
		if (og.type) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			property: "og:type",
			content: og.type
		}, key++));
		if (og.locale) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			property: "og:locale",
			content: og.locale
		}, key++));
		if (og.publishedTime) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			property: "article:published_time",
			content: og.publishedTime
		}, key++));
		if (og.modifiedTime) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			property: "article:modified_time",
			content: og.modifiedTime
		}, key++));
		if (og.authors) for (const author of og.authors) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		...
		if (og.images) {
			...
			for (const img of imgList) {
				...
				elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
					property: "og:image",
					content: resolveUrl(imgUrl) ?? imgUrl
				}, key++));
				if (typeof img !== "string") {
					if (img.width) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
						property: "og:image:width",
						content: String(img.width)
					}, key++));
					if (img.height) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
						property: "og:image:height",
						content: String(img.height)
					}, key++));
					if (img.alt) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		...
		if (og.videos) for (const video of og.videos) {
			elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
				property: "og:video",
				content: resolveUrl(video.url) ?? video.url
			}, key++));
			if (video.width) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
				property: "og:video:width",
				content: String(video.width)
			}, key++));
			if (video.height) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
				property: "og:video:height",
				content: String(video.height)
			}, key++));
		}
		if (og.audio) for (const audio of og.audio) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			property: "og:audio",
			content: resolveUrl(audio.url) ?? audio.url
		}, key++));
	}
	if (metadata.twitter) {
		const tw = metadata.twitter;
		if (tw.card) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "twitter:card",
			content: tw.card
		}, key++));
		if (tw.site) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "twitter:site",
			content: tw.site
		}, key++));
		if (tw.siteId) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "twitter:site:id",
			content: tw.siteId
		}, key++));
		if (tw.title) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "twitter:title",
			content: tw.title
		}, key++));
		if (tw.description) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "twitter:description",
			content: tw.description
		}, key++));
		if (tw.creator) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "twitter:creator",
			content: tw.creator
		}, key++));
		if (tw.creatorId) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		...
		if (tw.images) {
			...
			for (const img of imgList) {
				...
				if (typeof img !== "string" && img.alt) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		...
		if (tw.players) {
			...
			for (const player of players) {
				...
				elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
					name: "twitter:player",
					content: resolveUrl(playerUrl) ?? playerUrl
				}, key++));
				elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
		...
		if (tw.app) {
			...
			for (const platform of [
				...
				if (app.name) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
					name: `twitter:app:name:${platform}`,
					content: app.name
				}, key++));
				if (app.id[platform] !== void 0) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
	...
	if (metadata.icons) {
		...
		if (shortcut) {
			...
			for (const s of shortcuts) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
				rel: "shortcut icon",
				href: resolveUrl(s) ?? s
			}, key++));
		}
		if (icon) {
			...
			for (const i of icons) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
				rel: "icon",
		...
		if (apple) {
			...
			for (const a of apples) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
		...
		if (other) for (const o of other) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
			rel: o.rel,
			href: resolveUrl(o.url) ?? o.url,
			...o.sizes ? { sizes: o.sizes } : {}
		}, key++));
	}
	if (metadata.manifest) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
		rel: "manifest",
		href: resolveUrl(metadata.manifest) ?? metadata.manifest
	}, key++));
	if (metadata.alternates) {
		const alt = metadata.alternates;
		if (alt.canonical) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
			rel: "canonical",
			href: resolveUrl(alt.canonical) ?? alt.canonical
		}, key++));
		if (alt.languages) for (const [lang, href] of Object.entries(alt.languages)) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
			rel: "alternate",
			hrefLang: lang,
			href: resolveUrl(href) ?? href
		}, key++));
		if (alt.media) for (const [media, href] of Object.entries(alt.media)) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
			rel: "alternate",
			media,
			href: resolveUrl(href) ?? href
		}, key++));
		if (alt.types) for (const [type, href] of Object.entries(alt.types)) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
			rel: "alternate",
			type,
			href: resolveUrl(href) ?? href
		}, key++));
	...
	if (metadata.verification) {
		...
		if (v.google) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "google-site-verification",
			content: v.google
		}, key++));
		if (v.yahoo) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "y_key",
			content: v.yahoo
		}, key++));
		if (v.yandex) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "yandex-verification",
			content: v.yandex
		}, key++));
		if (v.other) for (const [name, content] of Object.entries(v.other)) {
			const values = Array.isArray(content) ? content : [content];
			for (const val of values) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
				name,
				content: val
			}, key++));
		}
	...
	if (metadata.appleWebApp) {
		...
		if (awa.capable !== false) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "mobile-web-app-capable",
			content: "yes"
		}, key++));
		if (awa.title) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "apple-mobile-web-app-title",
			content: awa.title
		}, key++));
		if (awa.statusBarStyle) elements.push((0, import_jsx_runtime_react_server.jsx)("meta", {
			name: "apple-mobile-web-app-status-bar-style",
			content: awa.statusBarStyle
		}, key++));
		if (awa.startupImage) {
			const imgs = typeof awa.startupImage === "string" ? [{ url: awa.startupImage }] : awa.startupImage;
			for (const img of imgs) elements.push((0, import_jsx_runtime_react_server.jsx)("link", {
...
function checkHasConditions(has, missing, ctx) {
	if (has) {
		for (const condition of has) if (!checkSingleCondition(condition, ctx)) return false;
	}
	if (missing) {
		for (const condition of missing) if (checkSingleCondition(condition, ctx)) return false;
	}
	return true;
}
/**
...
function matchRedirect(pathname, redirects, ctx) {
	...
	if (index.localeStatic.size > 0) {
		...
		if (noLocaleBucket) for (const entry of noLocaleBucket) {
			...
			let dest = substituteDestinationParams(redirect.destination, { [entry.paramName]: "" });
		...
		if (slashTwo !== -1) {
			...
			if (localeBucket) for (const entry of localeBucket) {
				...
				let dest = substituteDestinationParams(redirect.destination, { [entry.paramName]: localePart });
				dest = sanitizeDestination(dest);
				localeMatch = {
					destination: dest,
					permanent: redirect.permanent
	...
	for (const rewrite of rewrites) {
		...
		if (params) {
			if (rewrite.has || rewrite.missing) {
				if (!checkHasConditions(rewrite.has, rewrite.missing, ctx)) continue;
			}
...
var _g$4 = globalThis;
var _als$2 = _g$4[_ALS_KEY$3] ??= new AsyncLocalStorage$1();
/**
...
var MemoryCacheHandler = class {
	...
	async set(key, data, ctx) {
		const tags = [];
		if (data && "tags" in data && Array.isArray(data.tags)) tags.push(...data.tags);
		if (ctx && "tags" in ctx && Array.isArray(ctx.tags)) tags.push(...ctx.tags);
		let revalidateAt = null;
		if (ctx) {
			const revalidate = ctx.cacheControl?.revalidate ?? ctx.revalidate;
			if (typeof revalidate === "number" && revalidate > 0) revalidateAt = Date.now() + revalidate * 1e3;
		}
		if (data && "revalidate" in data && typeof data.revalidate === "number") revalidateAt = Date.now() + data.revalidate * 1e3;
		this.store.set(key, {
			value: data,
			tags,
...
var _g$2 = globalThis;
var _als$1 = _g$2[_ALS_KEY$1] ??= new AsyncLocalStorage$1();
var _fallbackState$1 = _g$2[_FALLBACK_KEY$1] ??= { currentRequestTags: [] };
...
var cacheContextStorage = _gCacheRuntime[_CONTEXT_ALS_KEY] ??= new AsyncLocalStorage$1();
...
var _g$1 = globalThis;
var _privateAls = _g$1[_PRIVATE_ALS_KEY] ??= new AsyncLocalStorage$1();
_g$1[_PRIVATE_FALLBACK_KEY] ??= { cache: /* @__PURE__ */ new Map() };
/**
...
function runWithPrivateCache(fn) {
	const state = { cache: /* @__PURE__ */ new Map() };
...
_registerStateAccessors({
	...
	setServerContext(ctx) {
		...
		if (state) state.serverContext = ctx;
		else _fallbackState.serverContext = ctx;
	},
	...
	clearInsertedHTMLCallbacks() {
		const state = _als.getStore();
		if (state) state.serverInsertedHTMLCallbacks = [];
		else _fallbackState.serverInsertedHTMLCallbacks = [];
	}
});
/**
...
var Noto_Serif = /* @__PURE__ */ createFontLoader("Noto Serif");
var ssrFontStyles = [];
var ssrFontPreloads = [];
/**
...
var themePrimitiveProbeContract = [
	"pageChrome",
	"card",
	"panel",
	"button",
...
var themePrimitiveProbeEntries = [
	{
		testId: "theme-probe-page",
		primitive: "pageChrome",
		styles: themePrimitiveProbeStyles.pageChrome
	},
	{
		testId: "theme-probe-card",
		primitive: "card",
		styles: themePrimitiveProbeStyles.card
	},
	{
		testId: "theme-probe-panel",
		primitive: "panel",
		styles: themePrimitiveProbeStyles.panel
	},
	{
		testId: "theme-probe-button",
		primitive: "button",
		styles: themePrimitiveProbeStyles.button
	},
	{
		testId: "theme-probe-input",
		primitive: "input",
		styles: themePrimitiveProbeStyles.input
	},
	{
		testId: "theme-probe-overlay",
		primitive: "overlayPanelNarrow",
		styles: themePrimitiveProbeStyles.overlayPanelNarrow
	}
];
var uiThemeProbeContract = themePrimitiveProbeContract;
var uiThemeProbeEntries = themePrimitiveProbeEntries;
var uiThemeProbeStyles = {
	rail: {
		kVAEAm: "xixxii4",
		kzqmXN: "x1i1rx1s",
		kZKoxP: "xjm9jq1",
...
var InputPerformanceMode_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "c24a721b6251", "default");
var AppThemeBoundary_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "f34657f09c1d", "default");
var QueryProvider = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'QueryProvider' is called on server");
}, "b49f265d533b", "QueryProvider");
var I18nProvider = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'I18nProvider' is called on server");
}, "c951643367b4", "I18nProvider");
...
var bodyFont = Manrope({
	subsets: ["latin", "cyrillic"],
	display: "swap",
	variable: "--font-body"
});
var displayFont = Noto_Serif({
	subsets: ["latin", "cyrillic"],
	display: "swap",
...
var themeBootScript = `(function(){try{var key='silent-moonfall-theme-mode';var stored=localStorage.getItem(key);var mode=stored==='light'||stored==='dark'||stored==='system'?stored:'system';var resolved=mode==='system'?(window.matchMedia('(prefers-color-scheme: light)').matches?'light':'dark'):mode;document.documentElement.dataset.theme=resolved;document.documentElement.dataset.themeMode=mode;document.body.dataset.theme=resolved;document.body.dataset.themeMode=mode;}catch(_error){}})();`;
function RootLayout({ children }) {
	const themeProbeSlot = /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
		"data-testid": "theme-primitives-probe",
		"data-theme-primitives": uiThemeProbeContract.join(","),
		"aria-hidden": "true",
		...props(uiThemeProbeStyles.rail),
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
			...props(uiThemeProbeStyles.stack),
			children: uiThemeProbeEntries.map((entry) => {
				if (entry.primitive === "pageChrome") return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					"data-testid": entry.testId,
					"data-theme-probe-primitive": entry.primitive,
					...props(...entry.styles, uiThemeProbeStyles.page)
				}, entry.testId);
				if (entry.primitive === "button") return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("button", {
					"data-testid": entry.testId,
					"data-theme-probe-primitive": entry.primitive,
					type: "button",
					tabIndex: -1,
					...props(...entry.styles, uiThemeProbeStyles.button),
					children: "Theme probe"
				}, entry.testId);
				if (entry.primitive === "input") return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("input", {
					"data-testid": entry.testId,
					"data-theme-probe-primitive": entry.primitive,
					tabIndex: -1,
					readOnly: true,
				...
				if (entry.primitive === "overlayPanelNarrow") return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					"data-testid": entry.testId,
					"data-theme-probe-primitive": entry.primitive,
					...props(...entry.styles, uiThemeProbeStyles.overlay)
				}, entry.testId);
				return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					"data-testid": entry.testId,
					"data-theme-probe-primitive": entry.primitive,
					...props(...entry.styles, uiThemeProbeStyles.surface)
				}, entry.testId);
			})
		})
	});
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("html", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("body", {
			suppressHydrationWarning: true,
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(styled_components_registry_default, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("script", { dangerouslySetInnerHTML: { __html: themeBootScript } }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(InputPerformanceMode_default, {}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ThemeProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(AppThemeBoundary_default, {
					qaSlot: themeProbeSlot,
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(QueryProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(I18nProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(import_react_react_server.Suspense, {
						fallback: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { ...props(rootLayoutStyles.fallback) }),
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							...props(rootLayoutStyles.content),
							children
						})
					}) }) })
				}) })
...
var PortalShell_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "1b6f97ab563a", "default");
enumType([
	"Чертила",
	"VIP",
	"Boobs",
...
var profileTitleSchema = enumType([
	"Striker",
	"Strategist",
	"Vanguard",
	"Scout",
...
var profileInterestSchema = enumType([
	"pvp",
	"absences-planning",
	"raid-prep",
	"matchmaking",
...
var notificationDefaultsSchema = objectType({
	helpRequests: booleanType(),
	absenceApprovals: booleanType(),
	pvpMatches: booleanType(),
	eventReminders: booleanType()
});
arrayType(objectType({
	...
	preferredClasses: arrayType(stringType()).optional(),
	interests: arrayType(profileInterestSchema).optional(),
...
var portalAccountIdSchema = stringType().regex(/^\d+$/);
var pinAuthUserIdSchema = stringType().regex(/^pin-(guest|member|officer|head|sysadmin)$/);
...
optionalAnyEnv("MEMBER_PASSWORD", "MEMBER_PIN"), optionalAnyEnv("OFFICER_PASSWORD", "OFFICER_PIN"), optionalAnyEnv("HEAD_PASSWORD", "HEAD_PIN", "GM_PASSWORD", "GM_PIN"), optionalAnyEnv("SYSADMIN_PASSWORD", "SYSADMIN_PIN");
var jwtSecretCache = null;
function getJwtSecret() {
	if (!jwtSecretCache) jwtSecretCache = requireEnv("JWT_SECRET");
	return jwtSecretCache;
}
process.env.ALLOWED_ORIGINS?.split(",");
process.env.DISCORD_BOT_API_URL;
function hasValidAuthId(authMethod, id) {
	if (authMethod === "pin") return !id || pinAuthUserIdSchema.safeParse(id).success;
...
function verifyToken(token) {
	try {
		...
		if (!hasValidAuthId(authMethod, decoded.id)) return null;
		return {
			id: decoded.id,
			...
			notificationDefaults: decoded.notificationDefaults || void 0,
			exp: decoded.exp
		};
	} catch (error) {
		return null;
...
var pendingValues = /* @__PURE__ */ new Map();
...
async function runServerTaskOnce(key, task) {
	await getOrCreate(`task:${key}`, task);
}
async function getCachedTableColumns(tableName) {
...
async function ensureAccountsSchema() {
	await runServerTaskOnce("schema:portal_account", async () => {
		const pool = getPool();
		await pool.query(`
    ...
    `);
		...
		await pool.query(`ALTER TABLE portal_account ADD COLUMN IF NOT EXISTS class_name TEXT NULL;`).catch(() => void 0);
		await pool.query(`ALTER TABLE portal_account ADD COLUMN IF NOT EXISTS guild_name TEXT NULL;`).catch(() => void 0);
		await pool.query(`ALTER TABLE portal_account ADD COLUMN IF NOT EXISTS discord_handle TEXT NULL;`).catch(() => void 0);
		await pool.query(`ALTER TABLE portal_account ADD COLUMN IF NOT EXISTS prefix TEXT NULL;`).catch(() => void 0);
		await pool.query(`ALTER TABLE portal_account ADD COLUMN IF NOT EXISTS profile_title TEXT NULL;`).catch(() => void 0);
		await pool.query(`ALTER TABLE portal_account ADD COLUMN IF NOT EXISTS preferred_classes JSONB NOT NULL DEFAULT '[]'::jsonb;`).catch(() => void 0);
		await pool.query(`ALTER TABLE portal_account ADD COLUMN IF NOT EXISTS interests JSONB NOT NULL DEFAULT '[]'::jsonb;`).catch(() => void 0);
		await pool.query(`ALTER TABLE portal_account ADD COLUMN IF NOT EXISTS notification_defaults JSONB NOT NULL DEFAULT '{}'::jsonb;`).catch(() => void 0);
		await pool.query(`ALTER TABLE portal_account ALTER COLUMN role SET DEFAULT 'guest';`);
		await pool.query(`UPDATE portal_account SET role = 'head' WHERE role = 'gm';`).catch(() => void 0);
		await pool.query(`
...
function parseInterests(value) {
	return parseStringArray(value).filter((entry) => entry === "pvp" || entry === "absences-planning" || entry === "raid-prep" || entry === "matchmaking" || entry === "mentoring");
}
function parseNotificationDefaults(value) {
	if (!value || typeof value !== "object") return;
	const source = value;
	if (typeof source.helpRequests !== "boolean" || typeof source.absenceApprovals !== "boolean" || typeof source.pvpMatches !== "boolean" || typeof source.eventReminders !== "boolean") return;
	return {
...
function isPortalAccountId(value) {
	return Boolean(value && /^\d+$/.test(value));
}
async function resolveClassName(nickname) {
	...
	return (await pool.query(`SELECT ${classCol} AS class_name FROM registrations WHERE LOWER(${nickCol}) = LOWER($1) LIMIT 1`, [nickname])).rows[0]?.class_name || null;
}
async function resolveSessionFromToken(token) {
	...
	if (decoded.authMethod !== "pin") {
		if (!isPortalAccountId(decoded.id) || !hasDatabaseUrl()) return {
			valid: false,
	...
	} else user.className = await resolveClassName(decoded.nickname);
	return {
		valid: true,
		user
	};
}
var layout_exports = /* @__PURE__ */ __exportAll({ default: () => PortalLayout });
async function PortalLayout({ children }) {
	await connection();
	const token = (await cookies()).get("auth_token")?.value;
	const session = await resolveSessionFromToken(token);
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PortalShell_default, {
		runtime: "vinext",
		initialUser: session.valid ? session.user : null,
		children
	});
}
...
function __isrCacheKey(pathname, suffix) {
	...
	const prefix = "app:3ff2535d-46e1-4a3c-9d51-6b3f7db53f4b";
...
var routes = [
	...
	},
	{
		...
		routeHandler: null,
		layouts: [layout_exports$1, layout_exports],
		routeSegments: ["(portal)", "analytics"],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
		slots: {},
	...
	},
	{
		...
		patternParts: ["integrations"],
		isDynamic: false,
		params: [],
		page: page_exports$5,
		routeHandler: null,
		layouts: [layout_exports$1, layout_exports],
		routeSegments: ["(portal)", "integrations"],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
		slots: {},
...
var rootLayouts = [layout_exports$1, layout_exports];
/**
...
async function renderHTTPAccessFallbackPage(route, statusCode, isRscRequest, request, opts) {
	...
	const htmlStream = await (await import("./ssr.mjs")).handleSsr(rscStream, getNavigationContext(), fontData);
...
async function handler(request, ctx) {
	...
	const _run = () => runWithHeadersContext(headersCtx, () => runWithNavigationContext(() => _runWithCacheState(() => runWithPrivateCache(() => runWithFetchCache(async () => {
...
async function _handleRequest(request, __reqCtx, _mwCtx) {
	...
	for (const metaRoute of metadataRoutes) {
		...
		if (cleanPathname === metaRoute.servedUrl) if (metaRoute.isDynamic) {
	...
	if (route.routeHandler) {
		...
		if (exportedMethods.includes("GET") && !exportedMethods.includes("HEAD")) exportedMethods.push("HEAD");
		...
		if (typeof handlerFn === "function") {
			...
			try {
				...
				if (revalidateSeconds !== null && !dynamicUsedInHandler && (method === "GET" || isAutoHead) && !response.headers.has("cache-control")) response.headers.set("cache-control", "s-maxage=" + revalidateSeconds + ", stale-while-revalidate");
			...
			if (__cached && __cached.isStale && __cached.value.value && __cached.value.value.kind === "APP_PAGE") {
				...
				__triggerBackgroundRegeneration(cleanPathname, async function() {
					const __revalResult = await runWithHeadersContext({
						headers: new Headers(),
						cookies: /* @__PURE__ */ new Map()
					}, () => runWithNavigationContext(() => _runWithCacheState(() => runWithPrivateCache(() => runWithFetchCache(async () => {
						setNavigationContext({
							pathname: cleanPathname,
							searchParams: url.searchParams,
							params
						});
						const [__revalRscForSsr, __revalRscForCapture] = renderToReadableStream(await buildPageElement(route, params, void 0, url.searchParams), { onError: createRscOnErrorHandler(request, cleanPathname, route.pattern) }).tee();
						...
						const __revalHtmlStream = await (await import("./ssr.mjs")).handleSsr(__revalRscForSsr, getNavigationContext(), __revalFontData);
						setHeadersContext(null);
						setNavigationContext(null);
	...
	try {
		...
		if (buildErr && typeof buildErr === "object" && "digest" in buildErr) {
			...
			if (digest === "NEXT_NOT_FOUND" || digest.startsWith("NEXT_HTTP_ERROR_FALLBACK;")) {
				...
				setHeadersContext(null);
				setNavigationContext(null);
				return new Response(statusCode === 403 ? "Forbidden" : statusCode === 401 ? "Unauthorized" : "Not Found", { status: statusCode });
			}
		}
	...
	let htmlStream;
	try {
		htmlStream = await (await import("./ssr.mjs")).handleSsr(__rscForResponse, getNavigationContext(), fontData);
	} catch (ssrErr) {
