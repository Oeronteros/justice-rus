...
//#endregion
//#region shims/pg-native.ts
var pg_native_exports = /* @__PURE__ */ __exportAll({ default: () => null });
var init_pg_native = __esmMin((() => {}));
//#endregion
...
var require_client = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Native;
	try {
		Native = (init_pg_native(), __toCommonJS(pg_native_exports));
	} catch (e) {
		throw e;
	}
	var TypeOverrides = require_type_overrides();
