...
var client_references_default = {
	"878b1d55daf9": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_878b1d55daf9;
	},
	"de2699100888": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_de2699100888;
	},
	"18b3d54f6901": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_18b3d54f6901;
	},
	"c18db9305e40": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_c18db9305e40;
	},
	"7346d135c2b4": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_7346d135c2b4;
	},
	"5f1cc293b170": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_5f1cc293b170;
	},
	"794020b36b9c": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_794020b36b9c;
	},
	"cd3e30d9f56e": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_cd3e30d9f56e;
	},
	"982569dea541": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_982569dea541;
	},
	"809ff3c8fbc4": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_809ff3c8fbc4;
	},
	"97c65a20db9f": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_97c65a20db9f;
	},
	"fc255789ffde": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_fc255789ffde;
	},
	"7a5c8250a36c": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_7a5c8250a36c;
	},
	"ed7d606e58f7": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_ed7d606e58f7;
	},
	"c24a721b6251": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_c24a721b6251;
	},
	"1b6f97ab563a": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_1b6f97ab563a;
	},
	"f34657f09c1d": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_f34657f09c1d;
	},
	"c951643367b4": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_c951643367b4;
	},
	"b49f265d533b": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_b49f265d533b;
	},
	"3a8a44ae8cda": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_3a8a44ae8cda;
	},
	"f29e6e234fea": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_f29e6e234fea;
	},
	"0deffcb8ffd7": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry--9RyiJtI.js")).export_0deffcb8ffd7;
	}
};
//#endregion
...
var ServerInsertedHTMLContext = typeof React$1.createContext === "function" ? React$1.createContext(null) : null;
/**
...
function getLayoutSegmentContext() {
	if (_LayoutSegmentCtx === null && typeof React$1.createContext === "function") _LayoutSegmentCtx = React$1.createContext([]);
...
//#endregion
export { usePathname as a, useServerInsertedHTML as c, __exportAll as d, _virtual_vinext_app_ssr_entry_default as default, __reExport as f, __toESM as h, handleSsr, toRscUrl as i, __commonJSMin as l, __toCommonJS as m, getPrefetchedUrls as n, useRouter as o, __require as p, storePrefetchResponse as r, useSearchParams as s, getLayoutSegmentContext as t, __esmMin as u };
