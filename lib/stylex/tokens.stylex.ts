...
export const colors = stylex.defineVars({
  ...
  accentEdge: 'rgba(223, 199, 160, 0.38)',
  accentEdgeStrong: 'rgba(232, 215, 187, 0.76)',
  ember: '#8b403a',
  emberStrong: '#9a4740',
  ...
  surfaceBase: 'rgba(17, 19, 24, 0.94)',
  surfaceRaised: 'rgba(20, 23, 30, 0.9)',
  surfaceSoft: 'rgba(24, 27, 34, 0.82)',
  surfaceField: 'rgba(18, 20, 26, 0.96)',
  lineSoft: 'rgba(184, 160, 111, 0.22)',
  lineMuted: 'rgba(146, 126, 92, 0.38)',
  lineStrong: 'rgba(214, 190, 152, 0.56)',
  focusRing: 'rgba(232, 215, 187, 0.72)',
  focusGlow: 'rgba(169, 71, 63, 0.24)',
