...
const vinextRouteParityManifest: readonly VinextRouteParityEntry[] = [
  {
    ...
    cutoverWave: 'all',
    status: 'blocked',
    blocker: 'Missing vinext route file for root dashboard shell.',
    rollbackScope: 'off',
  },
  {
    route: '/about',
    ...
    cutoverWave: 'all',
    status: 'blocked',
    blocker: 'No dedicated /about route in Next or vinext; currently aliased by nav to /.',
    rollbackScope: 'off',
  },
  {
    route: '/news',
  ...
  },
  {
    ...
    cutoverWave: 'all',
    status: 'blocked',
    blocker: 'Missing vinext route file for workflow section.',
    rollbackScope: 'off',
  },
  {
    route: '/integrations',
    ...
    cutoverWave: 'all',
    status: 'blocked',
    blocker: 'Missing vinext route file for integrations section root.',
    rollbackScope: 'off',
  },
] as const;
