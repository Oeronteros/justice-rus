import { n as __commonJSMin, t as require_react_react_server } from "./react.react-server-BJARnplL.js";
import { t as require_react_dom_react_server } from "./react-dom.react-server-CkrX5NDy.js";
...
//#endregion
//#region node_modules/@vitejs/plugin-rsc/dist/vendor/react-server-dom/cjs/react-server-dom-webpack-server.edge.development.js
/**
* @license React
...
var require_react_server_dom_webpack_server_edge_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	"production" !== process.env.NODE_ENV && (function() {
		...
		function getChunk(response, id) {
			var chunks = response._chunks, chunk = chunks.get(id);
			chunk || (chunk = response._formData.get(response._prefix + id), chunk = "string" === typeof chunk ? new ReactPromise("resolved_model", chunk, _defineProperty({ id }, RESPONSE_SYMBOL, response)) : response._closed ? new ReactPromise("rejected", null, response._closedReason) : new ReactPromise("pending", null, null), chunks.set(id, chunk));
			return chunk;
		}
		function fulfillReference(response, reference, value, arrayRoot) {
			var handler = reference.handler, parentObject = reference.parentObject, key = reference.key, map = reference.map, path = reference.path;
...
var require_server_edge = /* @__PURE__ */ __commonJSMin(((exports) => {
	var s;
	if (process.env.NODE_ENV === "production") s = require_react_server_dom_webpack_server_edge_production();
	else s = require_react_server_dom_webpack_server_edge_development();
