...
import { E as usePathname, O as useSearchParams, T as useParams } from "./navigation-BIaMe2a9.js";
...
var useRoute = () => {
	...
	return {
		route: computeRoute(path, Object.keys(params).length ? params : Object.fromEntries(searchParams.entries())),
		path
	};
};
...
function AnalyticsComponent(props) {
	...
	return /* @__PURE__ */ import_react.createElement(Analytics, {
		path,
		route,
		...props,
...
function Analytics2(props) {
	return /* @__PURE__ */ import_react.createElement(import_react.Suspense, { fallback: null }, /* @__PURE__ */ import_react.createElement(AnalyticsComponent, { ...props }));
}
//#endregion
export { Analytics2 as Analytics };
