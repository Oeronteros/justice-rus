...
import { E as usePathname, O as useSearchParams, T as useParams } from "./navigation-DyqcGQKS.js";
...
function SpeedInsightsComponent(props) {
	...
	return /* @__PURE__ */ import_react.createElement(SpeedInsights, {
		route,
		...props,
		framework: "next",
...
function SpeedInsights2(props) {
	return /* @__PURE__ */ import_react.createElement(import_react.Suspense, { fallback: null }, /* @__PURE__ */ import_react.createElement(SpeedInsightsComponent, { ...props }));
}
//#endregion
export { SpeedInsights2 as SpeedInsights };
