...
import { i as withBasePath, n as toBrowserNavigationHref, r as toSameOriginAppPath, t as resolveRelativeHref } from "./url-utils-CpXKNYEw.js";
import { C as toRscUrl, S as storePrefetchResponse, h as getPrefetchedUrls } from "./navigation-DyqcGQKS.js";
import { n as appendSearchParamsToUrl, r as urlQueryToSearchParams } from "./query-CnMRjpQT.js";
...
function useLinkStatus() {
	return (0, import_react.useContext)(LinkStatusContext);
}
...
var Link = (0, import_react.forwardRef)(function Link({ href, as, replace = false, prefetch: prefetchProp, scroll = true, children, onClick, onNavigate, ...rest }, forwardedRef) {
	...
	const handleClick = async (e) => {
		...
		if (typeof window.__VINEXT_RSC_NAVIGATE__ === "function") {
			...
			const Router = (await import("./router-CfKcDLNm.js")).default;
	...
	return (0, import_jsx_runtime.jsx)(LinkStatusContext.Provider, {
