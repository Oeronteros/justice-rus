 ...
 */
export declare function invalidateRouteCache(pagesDir: string): void;
/**
 ...
 */
export declare function pagesRouter(pagesDir: string, pageExtensions?: readonly string[], matcher?: ValidFileMatcher): Promise<Route[]>;
/**
 * Match a URL path against a route pattern.
 * Returns the matched params or null if no match.
 */
export declare function matchRoute(url: string, routes: Route[]): {
    route: Route;
 ...
 */
export declare function apiRouter(pagesDir: string, pageExtensions?: readonly string[], matcher?: ValidFileMatcher): Promise<Route[]>;
/**
