    ...
    if (metadata.twitter) {
        ...
        if (tw.players) {
            ...
            for (const player of players) {
                ...
                elements.push(_jsx("meta", { name: "twitter:player", content: resolveUrl(playerUrl) ?? playerUrl }, key++));
                elements.push(_jsx("meta", { name: "twitter:player:stream", content: resolveUrl(streamUrl) ?? streamUrl }, key++));
        ...
        if (tw.app) {
            ...
            for (const platform of ["iphone", "ipad", "googleplay"]) {
                ...
                if (app.url?.[platform] !== undefined) {
                    ...
                    elements.push(_jsx("meta", { name: `twitter:app:url:${platform}`, content: resolveUrl(appUrl) ?? appUrl }, key++));
                }
            }
        }
    }
