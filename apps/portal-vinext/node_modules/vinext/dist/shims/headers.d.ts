 ...
 */
export declare function throwIfInsideCacheScope(apiName: string): void;
/**
 ...
 */
export declare function getHeadersContext(): HeadersContext | null;
