 ...
 */
export declare function escapeHeaderSource(source: string): string;
/**
 ...
 */
export declare function matchConfigPattern(pathname: string, pattern: string): Record<string, string> | null;
/**
 ...
 */
export declare function matchRedirect(pathname: string, redirects: NextRedirect[], ctx: RequestContext): {
    destination: string;
    permanent: boolean;
} | null;
/**
 ...
 */
export declare function proxyExternalRequest(request: Request, externalUrl: string): Promise<Response>;
/**
 ...
 */
export declare function matchHeaders(pathname: string, headers: NextHeader[], ctx: RequestContext): Array<{
    key: string;
    value: string;
}>;
