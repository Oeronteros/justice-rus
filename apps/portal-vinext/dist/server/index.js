...
var InputPerformanceMode_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "e486da50e5de", "default");
//#endregion
//#region ../../components/platform/AppTelemetry.tsx
var AppTelemetry_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "fc1ddee70fd0", "default");
//#endregion
...
}, "38d010f48001", "I18nProvider");
//#endregion
//#region ../../lib/platform/runtime.ts
function isVinextRuntime(runtime = process.env.NEXT_PUBLIC_RUNTIME) {
	return runtime === "vinext";
}
function isNextRuntime(runtime = process.env.NEXT_PUBLIC_RUNTIME) {
	return !isVinextRuntime(runtime);
}
function shouldEnableTelemetry(env = {}) {
	const runtime = env.runtime ?? process.env.NEXT_PUBLIC_RUNTIME;
	return (env.vercel ?? process.env.VERCEL) === "1" && isNextRuntime(runtime);
}
//#endregion
...
function RootLayout({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("html", {
		lang: "ru",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("title", { children: "Silent Moonfall | Guild Portal" }) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("body", {
			className: "theme-wuxia",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(InputPerformanceMode_default, {}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(QueryProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(I18nProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(import_react_react_server.Suspense, {
					fallback: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { className: "relative z-10 min-h-screen" }),
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "relative z-10",
						children
					})
				}) }) }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(AppTelemetry_default, { enabled: shouldEnableTelemetry() })
			]
		})]
	});
}
...
optionalAnyEnv("OFFICER_PASSWORD", "OFFICER_PIN"), optionalAnyEnv("HEAD_PASSWORD", "HEAD_PIN", "GM_PASSWORD", "GM_PIN"), optionalAnyEnv("SYSADMIN_PASSWORD", "SYSADMIN_PIN");
...
function resolveSessionFromTokenStateless(token) {
	if (!token) return {
		valid: false,
...
function __isrCacheKey(pathname, suffix) {
	...
	const prefix = "app:336c18f3-253f-441a-b4c8-af9c66223432";
