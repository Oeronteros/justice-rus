...
import type { PortalAccount, User } from '@/types';
...
export default function ProfileSection({ user }: ProfileSectionProps) {
  const isAdmin = user.role === 'officer' || user.role === 'gm';
  ...
  const toggleAccount = async (account: PortalAccount) => {
    try {
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div className="p-4 rounded-xl bg-[#101a23]/70 border border-[#2a3c4c]/60">
              ...
              <div className="text-[#e6eff5] font-medium">{user.role}</div>
            </div>
            <div className="p-4 rounded-xl bg-[#101a23]/70 border border-[#2a3c4c]/60">
