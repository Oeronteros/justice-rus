...
export const shellStyles = stylex.create({
  ...
  groupTriggerCurrent: {
    ...
    background: `linear-gradient(140deg, ${colors.accentSoft}, ${colors.surfaceBase})`,
  },
  groupTriggerOpen: {
    borderColor: colors.accentEdgeStrong,
    boxShadow: `0 12px 22px ${colors.shadowSoft}`,
  },
  groupTriggerContent: {
    display: 'grid',
    gap: spacing.xxs,
  ...
  desktopSubmenuPanel: {
    ...
    border: `1px solid ${colors.lineMuted}`,
    background:
      `radial-gradient(circle at 100% 0%, ${colors.accentMuted}, transparent 34%), linear-gradient(160deg, ${colors.surfaceRaised}, ${colors.surfaceBase})`,
    padding: spacing.md,
    boxShadow: `0 14px 28px ${colors.shadowSoft}`,
  },
  desktopSubmenuPanelHeader: {
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'space-between',
    gap: spacing.md,
  ...
  desktopSubmenuPanelCopy: {
    display: 'grid',
    gap: spacing.xxs,
    minWidth: 0,
  },
  desktopSubmenuPanelTitle: {
    fontSize: '0.78rem',
    lineHeight: 1,
  ...
  desktopSubmenuLink: {
    minHeight: '56px',
    background: `linear-gradient(150deg, ${colors.surfaceRaised}, ${colors.surfaceBase})`,
  ...
  mobileDisclosureButtonCurrent: {
    borderColor: colors.accentEdge,
    background: `linear-gradient(140deg, ${colors.accentSoft}, ${colors.surfaceBase})`,
  },
  mobileDisclosureButtonOpen: {
    boxShadow: `0 10px 20px ${colors.shadowSoft}`,
  },
  mobileDisclosureCopy: {
    display: 'grid',
    gap: spacing.xxs,
    minWidth: 0,
  },
  mobileDisclosureHint: {
    fontSize: '0.78rem',
    lineHeight: 1.35,
    color: colors.paperStrong,
    whiteSpace: 'nowrap',
