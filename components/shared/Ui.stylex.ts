...
export const uiStyles = stylex.create({
  ...
  card: {
    ...
    background:
      `radial-gradient(circle at 10% 0%, rgba(139, 64, 58, 0.12), transparent 42%), radial-gradient(circle at 88% 10%, ${colors.accentMuted}, transparent 34%), linear-gradient(145deg, ${colors.surfaceBase}, ${colors.panelBottom})`,
